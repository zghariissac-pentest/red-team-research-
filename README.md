# Red Teaming Research (not completed yet)
...
### 1‑OpSec
How to operate safely, cleanly, and without leaving fingerprints.

### 2‑Infrastructure
C2 servers, redirectors, VPS setup, and operational infrastructure.

### 3‑Recon
Passive and active reconnaissance, automation tools, cloud recon.

### 4‑Initial Access
Phishing, payload delivery, macro attacks, web exploitation.

### 5‑Post Exploitation
Persistence, credential access, lateral movement, cloud actions.

### 6‑AD Attacks
Enumeration, Kerberos, privesc, domain dominance.

### 7‑Privilege Escalation
Windows, Linux, containers, cloud escalation.

### 8‑Bypassing Security
AV bypass, EDR evasion, obfuscation, injection techniques.

### 9‑Reporting
Writing clean reports, executive summaries, attack paths.

### Resources
Books, cheatsheets, glossary, case studies.
